...
parfois lieu à des échanges de données confidentielles. Or, la sécurité des données et l'authentification des utilisateurs n'y est généralement pas assurée. Il est donc important 
...
de master en sécurité des systèmes d'information que nous avons étudié les protocoles cryptographiques permettant à plusieurs utilisateurs de s'authentifier et de communiquer de manière sécurisée à travers un
...
messagerie instantanée va permettre de pouvoir dialoguer avec des utilisateurs 
...
des outils cryptographiques forts mis en place empêchant toute lisibilité des 
