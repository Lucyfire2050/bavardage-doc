...
\draw (clientsec1.south east) edge[asym] node[below, align = center] {authentifé} (clientchat1.south west);
\draw (clientsec2.south west) edge[asym] node[below, align = center] {authentifé} (clientchat2.south east);
...
\hline
R1&Présentation de Git et installation le 26/11/12 par Julien.\\
\hline
R2&Présentation de Vala et Gtk par Julien.\\
\hline
R3&Toute l'équipe doit s'informer sur OpenSSL.\\
\hline
R4&Répartition de la charge de travail sur les membres (possible rapidement grâce à Git).\\
\hline
